...
class H5TrajIndex:
    """Map global sample index -> (file_idx, batch_idx). Accept 4D (T,W,H,C) or 5D (B,T,W,H,C)."""
...
class H5LazyArray:
    ...
    """
    def __init__(self, files: List[str], dataset_key: Optional[str]):
        ...
        # Probe W,H,C on the first available file
        ...
        # Compute per-trajectory T and T_min
        self._T_list = []
...
class GenericH5PairIterable(IterableDataset):
    ...
    def __init__(self,
        ...
        # lazy arrays so TestDataset / utilities can index from disk
